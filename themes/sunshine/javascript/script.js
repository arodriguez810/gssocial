...
(function () {
    ...
    !function (t, l) {
        return t.fn.autogrow = function (i) {
            if (null == i && (i = {}), null == i.horizontal && (i.horizontal = !0), null == i.vertical && (i.vertical = !0), null == i.debugx && (i.debugx = -1e4), null == i.debugy && (i.debugy = -1e4), null == i.debugcolor && (i.debugcolor = "yellow"), null == i.flickering && (i.flickering = !0), null == i.postGrowCallback && (i.postGrowCallback = function () {
            }), null == i.verticalScrollbarWidth && (i.verticalScrollbarWidth = e()), i.horizontal !== !1 || i.vertical !== !1) return this.filter("textarea").each(function () {
                var e, n, r, o, a, c, d;
                ...
                }).appendTo(document.body), i.horizontal === !1 ? n.css({width: e.width()}) : (r = e.css("font-size"), n.css("padding-right", "+=" + r), n.normalPaddingRight = n.css("padding-right")), d = function (t) {
                    return function (l) {
                        var r, d, s;
...
!function (e) {
    ...
    }, n = 27, o = 9, s = 13, i = 38, a = 39, u = 40, r = e.noop;
    ...
    l.utils = t, e.Autocomplete = l, l.defaults = {
        ...
        initialize: function () {
            ...
            if (o === document.body || t.options.forceFixPosition) {
                var s = t.options.orientation, i = n.outerHeight(), a = t.el.outerHeight(), u = t.el.offset(),
                    r = {top: u.top, left: u.left};
                if ("auto" === s) {
                    var l = e(window).height(), c = e(window).scrollTop(), g = -c + u.top - i,
                        d = c + l - (u.top + a + i);
            ...
            if (this.suggestions.length) {
                var t, n = this, o = n.options, s = o.groupBy, i = o.formatResult, a = n.getQuery(n.currentValue),
                    u = n.classes.suggestion, r = n.classes.selected, l = e(n.suggestionsContainer),
                    c = e(n.noSuggestionsContainer), g = o.beforeRender, d = "";
            ...
            var t = this, n = t.options.beforeRender, o = e(t.suggestionsContainer), s = e(t.noSuggestionsContainer);
            ...
            var t, n = this.options, o = e(this.suggestionsContainer);
            ...
            var n = this, o = n.options.onSelect, s = n.suggestions[t];
...
!function (e) {
    ...
    var t, n, i, o, r, a, s = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", p = "Change", u = "mfp",
        f = "." + u, m = "mfp-ready", g = "mfp-removing", h = "mfp-prevent-close", v = function () {
...
!function (t) {
    t.rcrop = {
        ...
        var r = this, a = "rcrop-", o = {x: 0, y: 0, width: 0, height: 0};
        this.el = e instanceof t ? e : t(e), this.image = {
            instance: null,
            width: 0,
            height: 0
        }, this.wrapper = t("<div>", {class: "rcrop-wrapper"}), this.cropArea = t("<div>", {class: "rcrop-croparea"}), this.cropData = {
            width: 0,
            height: 0,
            x: 0,
            y: 0
        ...
        var n = function () {
            ...
            var t = r.cropArea.position(), e = o.width !== Math.round(r.cropArea.width()),
                i = o.height !== Math.round(r.cropArea.height()), a = o.x !== Math.round(t.left),
            ...
            var t = r.el[0].getBoundingClientRect(), e = t.width, i = t.height, a = r.clayfy.newSize,
            ...
            r.cropArea.css({
                ...
                top: o.top / i * 100 + "%",
                left: o.left / e * 100 + "%"
            }), r.outer.left.width(o.left / e * 100 + "%"), r.outer.top.height(o.top / i * 100 + "%"), r.outer.bottom.css({top: (o.top + o.height) / i * 100 + "%"}), r.outer.right.css({left: (o.left + o.width) / e * 100 + "%"})
        }, d = function () {
            ...
            var t = r.settings, e = r.clayfy.settings;
            ...
            var t = r.settings.preview.size, e = [],
        ...
        this.getValues = function () {
            return {width: r.cropData.width, height: r.cropData.height, y: r.cropData.y, x: r.cropData.x}
...
!function () {
    function e(e, i) {
        ...
        var p = function () {
            ...
            var t = s.getPosition(s.el), i = s.settings.overflow ? s.tempContainer : s.el.parent(), o = s.el.offset(),
            ...
            if (!0 !== s.settings.ghost && (n = {
                ...
                if (s.contentGhost.append(l), s.container.offset) {
                    var d = s.container.offset.innerBottom, g = s.container.offset.innerRight,
                        p = s.draggableBox.offset(), f = p.top + s.contentGhost.outerHeight() - d,
        ...
        var u, b, v, m, x = function () {
            $(s.settings.scrollable).each(function () {
                ...
                var t = w(e);
                if (!t.x && !t.y) return !0;
                var i = e[0].getBoundingClientRect(), o = z(e), r = parseInt(e.css("border-top-width")),
                    a = parseInt(e.css("border-left-width")), n = {
                        el: e,
                        top: i.top + r,
            ...
            var t = s.contentGhost ? s.contentGhost : s.draggableBox, i = s.draggableBox[0].getBoundingClientRect(),
                a = t.offset(), n = {
                    top: i.top,
        ...
        this.updateDropArea = function (e) {
            ...
            (e instanceof $ ? e : $(e)).each(function () {
                var e = $(this), t = e.offset(), i = e.outerHeight(), o = e.outerWidth(),
                    r = parseInt(e.css("border-top-width")), a = parseInt(e.css("border-left-width")),
                    n = $.clayfy.getInner(e);
        ...
        var H = function (e) {
            ...
            var t = s.contentGhost ? s.contentGhost : s.draggableBox, i = {}, o = s.el.offset(), r = {
                top: o.top,
                left: o.left,
            ...
            var t = e.pageX - s.el.offset().left, i = e.pageY - s.el.offset().top,
            ...
            if (l) {
                ...
                if (d) {
                    ...
                    s.initPos = {
                        ...
                        parent: t
                    }, s.history = {dX: [0, 0, 0], dY: [0, 0, 0], diffDX: 0, diffDY: 0}
                }
    ...
    function t(e, t) {
        ...
        this.getDraggableValues = function () {
            ...
            return {
                ...
                }, offset: e, outerWidth: i.draggableEl.outerWidth(), outerHeight: i.draggableEl.outerHeight()
            }
        }, function () {
    ...
    function i(t, i) {
        ...
        this.getSize = function () {
            ...
            var e = n.el.outerHeight(), t = n.el.outerWidth(), i = n.el.position(), o = i.left + n.parent.scrollLeft(),
            ...
            switch (o.position) {
                ...
                case"bottom right":
                    o.resizable.touchableDevice ? o.el.css({
                        ...
                        left: e.right - 20,
                        top: e.bottom - 20
                    }) : o.el.css({width: 8, height: 8, left: e.right - 8, top: e.bottom - 8})
            }
    ...
    function r(t, i) {
        ...
        var o, r = this, a = function (e) {
            ...
            var t = r.dropArea.parent().offset(), i = r.draggableBox.parent().offset(),
                a = r.el.position().left + (t.left - i.left), n = r.el.position().top + (t.top - i.top);
...
!function (a, u) {
    a.guessLanguage = (a.module || {}).exports = new function () {
        ...
        var n = 20, i = 300, t = {
            ...
            F = [["Armenian", "hy"], ["Hebrew", "he"], ["Bengali", "bn"], ["Gurmukhi", "pa"], ["Greek", "el"], ["Gujarati", "gu"], ["Oriya", "or"], ["Tamil", "ta"], ["Telugu", "te"], ["Kannada", "kn"], ["Malayalam", "ml"], ["Sinhala", "si"], ["Thai", "th"], ["Lao", "lo"], ["Tibetan", "bo"], ["Burmese", "my"], ["Georgian", "ka"], ["Mongolian", "mn"], ["Khmer", "km"], ["Pahawh Hmong", "hmn"]],
            o = "unknown",
            ...
            s = ["ru", "uk", "kk", "uz", "mn", "sr", "mk", "bg", "ky"], h = ["ar", "fa", "ps", "ur"], c = ["hi", "ne"],
            p = ["pt-BR", "pt-PT"], m = {
                "Basic Latin": /[\u0000-\u007F]/g,
        ...
        function d(a, e) {
            var n = function (a) {
                var u = {};
                for (var e in m) {
                    var n = a.match(m[e]), i = (n ? n.length : 0) / a.length;
                    u[e] = i
                }
                return u
            }(a);
            if (n["Hangul Syllables"] + n["Hangul Jamo"] + n["Hangul Compatibility Jamo"] >= .4) e.apply(u, ["ko"]); else if (n["Greek and Coptic"] >= .4) e.apply(u, ["el"]); else if (n.Hiragana + n.Katakana + n["Katakana Phonetic Extensions"] >= .2) e.apply(u, ["ja"]); else if (n["CJK Unified Ideographs"] + n.Bopomofo + n["Bopomofo Extended"] + n["KangXi Radicals"] >= .4) e.apply(u, ["zh"]); else if (n.Cyrillic >= .4) b(a, s, e); else if (n.Arabic + n["Arabic Presentation Forms-A"] + n["Arabic Presentation Forms-B"] >= .4) b(a, h, e); else if (n.Devanagari >= .4) b(a, c, e); else {
                for (var i = 0, t = F.length; i < t; i++) if (n[F[i][0]] >= .4) return void e.apply(u, [F[i][1]]);
        ...
        function b(a, e, i) {
            if (a.length < n) i.apply(u, [o]); else {
                for (var t = {}, r = function (a) {
                    ...
                    var l = e[F].toLowerCase(), s = y(l) || null;
                    s && (t[l] = A(r, s))
                }
                var h = [];
...
!function (t, e, i, s) {
    t.widget("ui.triggeredAutocomplete", t.extend(!0, {}, t.ui.autocomplete.prototype, {
        options: {trigger: "@", allowDuplicates: !1}, _create: function () {
            var e = this;
            ...
            i && (this.id_map = jQuery.parseJSON(i)), this.ac = t.ui.autocomplete.prototype, this.ac._create.apply(this, arguments), this.updateHidden(), this.options.select = function (t, i) {
                var s = e.contents, n = e.cursorPos, o = s.substring(n, s.length), r = s.substring(0, n);
            ...
            var i = this.element.val(), s = this.getCursor();
            ...
            t.isArray(this.options.source) ? (e = this.options.source, this.source = function (i, s) {
                ...
                s.xhr && s.xhr.abort(), s.xhr = t.ajax({
                    url: i, data: e, dataType: "json", success: function (i) {
            ...
            if (t.ownerDocument.selection) {
                ...
                if (!e) return 0;
                var i = t.createTextRange(), s = i.duplicate();
                return i.moveToBookmark(e.getBookmark()), s.setEndPoint("EndToStart", i), s.text.length
            }
        }, updateHidden: function () {
            var e = this.options.trigger, i = this.element.scrollTop(), s = this.element.val();
...
!function (e) {
    ...
    e.fn.attr2 = function () {
        ...
        return this.each(function () {
            e("input,select,textarea", this).not('input[name="postPrivacy"]').clearFields(t)
        })
