                 ...
                 <?php if ($updated == false) { ?>
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <li>[Improved] speed again after v4.3 update.</li>
                                <li>[Fixed] smtp related issues.</li>
                                <li>[Fixed] API related issues.</li>
...
<script>
var queries = [
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'daily');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'weekly');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'monthly');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'yearly');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'nothing_selected');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'select_all');",
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'deselect_all');",
];
