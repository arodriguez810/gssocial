                 ...
                 <?php if ($updated == false) { ?>
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <li>[Fixed] audio upload & sharing from admin panel if disabled, voice messages cannot be sent to users from the chat system.</li>
                                <li>[Fixed] featured posts are disabled, pro members still gain the "featured post" privilege.</li>
                                <li>[Fixed] when creating an advertisement in the audience section, if nothing is selected, there is an inscription: "nothing selected."</li>
                                <li>[Fixed] event dates is not correct on sunshine theme.</li>
                                <li>[Fixed] image rotation is not working correctly when you upload an image.</li>
                                <li>[Fixed] br is added automatically when adding a new custom page, which causes issues.</li>
                                <li>[Fixed] posting to friend timeline was not working.</li>
                                <li>[Fixed] the "load more" button in the "pastevent" page in event system was not working.</li>
                                <li>[Fixed] disabling monetization does not remove the subscription link from the logged-in user dropdown menu.</li>
                                <li>[Fixed] if you edit blogs, it deletes "é," "á," "í," "ó" characters.</li>
                                <li>[Fixed] the decimal point of the commodity amount in "market" was wrong.</li>
                                <li>[Fixed] if a blog was approved from admin side, the money and points were not being credited to the user.</li>
                                <li>[Fixed] sometimes uploading .docx doesn't work.</li>
                                <li>[Fixed] if the user cancels a transaction, it was going to oops page instead of the wallet page.</li>
                                <li>[Fixed] no one can see the comments added to reels.</li>
                                <li>[Fixed] when viewing the reels, you cannot see who added the reels; only the photo in a circle.</li>
                                <li>[Fixed] in the instagram mode version, there was no reels.</li>
                                <li>[Fixed] load more for reels in profile not work.</li>
                                <li>[Fixed] ok.ru login system had some issues.</li>
                                <li>[Fixed] cashfree payment method required updating.</li>
                                <li>[Fixed] login with wordpress was not working.</li>
                                <li>[Fixed] ig mode sometimes can't be activated.</li>
                                <li>[Fixed] 10+ api-related issues.</li>
                                <li>[Fixed] 34 other minor bugs in code and design.</li>
                        </ul>
...
<script>
var queries = [
    "INSERT INTO `Wo_Langs` (`id`, `lang_key`) VALUES (NULL, 'v43458');",
];
